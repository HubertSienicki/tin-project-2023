...
public class OrderDetailsController : ControllerBase
{
    ...
    public OrderDetailsController(IOrderDetailsRepository orderDetailsRepository, IOrderDetailsService orderDetailsService)
    {
    ...
    public Task<IActionResult> GetOrderDetailsByIdAsync(int orderid)
    {
        ...
        return orderDetails.Result != null && !orderDetails.Result.Any() ? Task.FromResult<IActionResult>(NotFound("No orders found for this given order id")) : Task.FromResult<IActionResult>(Ok(orderDetails.Result));
    }
    ...
    public Task<IActionResult> GetOrderDetailsByProductIdAsync(int productid)
    {
        ...
        return orderDetails.Result != null && !orderDetails.Result.Any() ? Task.FromResult<IActionResult>(NotFound("No orders found for this given product id")) : Task.FromResult<IActionResult>(Ok(orderDetails.Result));
    }
    [HttpPost("")]
    public Task<IActionResult> CreateOrderDetailsAsync([FromBody] OrderDetailsPost orderDetailsPost)
    {
        ...
        return orderDetails.Result == null ? Task.FromResult<IActionResult>(BadRequest("Order details could not be created")) : Task.FromResult<IActionResult>(Ok(orderDetails.Result));
    }
}